import{K as r}from"./index-C1DIXLxY.js";const e="iblShadowSpatialBlurPixelShader",o=`precision highp sampler2D;
#define PI 3.1415927
...
gl_FragColor=vec4(X.x/X.w,X.y/X.w,X.z/X.w,1.0);}`;r.ShadersStore[e]||(r.ShadersStore[e]=o);const t={name:e,shader:o};export{t as iblShadowSpatialBlurPixelShader};
