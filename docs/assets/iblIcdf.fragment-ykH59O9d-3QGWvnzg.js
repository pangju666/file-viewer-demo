import{K as t}from"./index-D0uYf7q_.js";import"./helperFunctions-B6l7xjR4-yj_HLqfG.js";const e="iblIcdfPixelShader",r=`#include<helperFunctions>
varying vUV: vec2f;
...
.r;var pixelLuminance: f32=fetchLuminance(input.vUV);outputColor.z=pixelLuminance/(2.0*PI*normalization);fragmentOutputs.color=vec4( outputColor,1.0);}`;t.ShadersStoreWGSL[e]||(t.ShadersStoreWGSL[e]=r);const c={name:e,shader:r};export{c as iblIcdfPixelShaderWGSL};
