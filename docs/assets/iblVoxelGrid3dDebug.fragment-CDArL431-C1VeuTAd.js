import{K as o}from"./index-C1DIXLxY.js";const e="iblVoxelGrid3dDebugPixelShader",a=`precision highp sampler3D;varying vec2 vUV;uniform sampler3D voxelTexture;uniform sampler2D voxelSlabTexture;uniform sampler2D textureSampler;uniform vec4 sizeParams;
...
glFragColor.rgb=mix(background.rgb,voxelSlab.rgb,voxelSlab.a)+voxel;glFragColor.a=1.0;}}`;o.ShadersStore[e]||(o.ShadersStore[e]=a);const i={name:e,shader:a};export{i as iblVoxelGrid3dDebugPixelShader};
