import{K as e}from"./index-D0uYf7q_.js";import"./oitFragment-CzamkMna-B4DNDG63.js";import"./openpbrUboDeclaration-B8d2CmYv-COZggDBR.js";import"./pbrDebug-BaHxKUgN-C24vD5Ni.js";import"./shadowsFragmentFunctions-BTnUXuIi-DuQKyG0i.js";import"./bumpFragment-CYeL8iFP-D7TvzRYb.js";import"./imageProcessingFunctions-BRFCK4SD-CmhJKOiV.js";import"./clipPlaneFragment-Cy-2F7Yo-hf5KrlnT.js";import"./logDepthDeclaration-CFvD74xO-CYINoEBh.js";import"./fogFragment-D5EHfUup-B3cbbDtn.js";import"./helperFunctions-B2nzyfKQ-CdYOXG84.js";import"./hdrFilteringFunctions-BU9scQXL-BKkxymUS.js";import"./harmonicsFunctions-CZZ-1EOO-CYT4iNDE.js";import"./pbrBRDFFunctions-Bg2CTZTy-pMDY3szX.js";import"./sceneUboDeclaration-D9SIaQVE-Bx7kskb9.js";import"./meshUboDeclaration-Ng_ry5TO-D799Bl_F.js";import"./mainUVVaryingDeclaration-C-ZlhovI-CccQayY2.js";const o="sceneFragmentDeclaration",A=`uniform mat4 viewProjection;
#ifdef MULTIVIEW
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=P);const _="openpbrNormalMapFragment",x=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=x);const m="openpbrBlockNormalFinal",z=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=z);const u="openpbrBaseLayerData",y=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);float geometry_thickness=0.0;
#ifdef BASE_WEIGHT
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=T);const ce={name:i,shader:T};export{ce as openpbrPixelShader};
