import{K as e}from"./index-C1DIXLxY.js";const t="morphTargetsVertexGlobalDeclaration",T=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=T);const r="morphTargetsVertexDeclaration",d=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=d);const n="morphTargetsVertexGlobal",i=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
float vertexID;
#endif
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=i);const f="morphTargetsVertex",o=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
