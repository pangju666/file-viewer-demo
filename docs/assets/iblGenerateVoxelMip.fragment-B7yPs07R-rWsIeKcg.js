import{K as e}from"./index-D0uYf7q_.js";const i="iblGenerateVoxelMipPixelShader",r=`precision highp float;precision highp sampler3D;varying vec2 vUV;uniform sampler3D srcMip;uniform int layerNum;void main(void) {ivec3 Coords=ivec3(2)*ivec3(gl_FragCoord.x,gl_FragCoord.y,layerNum);uint tex =
...
<< 7u;glFragColor.rgb=vec3(float(tex)/255.0f,0.0f,0.0f);glFragColor.a=1.0;}`;e.ShadersStore[i]||(e.ShadersStore[i]=r);
