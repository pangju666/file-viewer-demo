import{K as e}from"./index-C1DIXLxY.js";import"./mainUVVaryingDeclaration-C-ZlhovI-D9P8fh7j.js";import"./shadowsFragmentFunctions-BTnUXuIi-DM9QY7-1.js";const t="pbrFragmentExtraDeclaration",g=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=g);const o="subSurfaceScatteringFunctions",E=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=E);const i="pbrHelperFunctions",u=`#define MINIMUMVARIANCE 0.0005
...
#endif
}`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=L);const l="pbrDirectLightingFunctions",h=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=h);const n="pbrIBLFunctions",A=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=A);const f="pbrBlockNormalGeometric",C=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=C);const c="pbrBlockImageProcessing",v=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=v);const s="pbrBlockPrePass",S=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=S);const d="pbrDebug",p=`#if DEBUGMODE>0
