import{K as e}from"./index-D0uYf7q_.js";const i="bonesDeclaration",m=`#if NUM_BONE_INFLUENCERS>0
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=f);const r="instancesVertex",d=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=d);const a="bonesVertex",s=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=s);const n="bakedVertexAnimation",c=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
