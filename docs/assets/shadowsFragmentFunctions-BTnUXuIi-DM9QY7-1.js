import{K as e}from"./index-C1DIXLxY.js";const o="reflectionFunction",s=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=v);const r="shadowsFragmentFunctions",d=`#ifdef SHADOWS
